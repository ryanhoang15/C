...
int main(){
    ...
    cout << "Today is Julian date "<<duedate.getJulian()<<endl;;
    cout << "Tomorrrow is Julian date "<<(++duedate).getJulian()<<endl;;

    cout << "The very first Julian date was " << upDate(11,5,2018)-upDate(11,5,2018).getJulian()<<endl;

    cout << "The very first Julian date was " << today - today.getJulian()<<endl;
